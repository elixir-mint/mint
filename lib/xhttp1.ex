defmodule XHTTP1 do
  ...
  def request(%XHTTP1{request: %{state: :stream_request}} = conn, _method, _path, _headers, _body) do
  ...
  @doc """
  See `XHTTP.stream_request_body/3`.
  """
  @impl true
