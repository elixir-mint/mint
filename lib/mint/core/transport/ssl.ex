defmodule Mint.Core.Transport.SSL do
  ...
  defp raise_on_missing_castore! do
    Code.ensure_loaded?(CAStore) ||
      ...
      within :transport_options. From OTP 25, you can also use :public_key.cacerts_get/0
      to get certificates that you loaded from files or from the OS with \
      :public_key.cacerts_load/0,1. See: https://www.erlang.org/blog/my-otp-25-highlights/#ca-certificates-can-be-fetched-from-the-os-standard-place
      """
  end
